...
public class FragenServiceImpl implements FragenService
{
	...
	/**
	 * Berechnet die Punktzahl des Spielers für eine der Fragen 
	 * im gespeicherten Fragensatz.
	 * 
	 * @param index Index der Frage, für die die Punktzahl berechnet werden soll.
	 * @return Punktzahl für die Frage.
	 */
